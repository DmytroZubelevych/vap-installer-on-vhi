...
instTypeFields.poc[0].items.values = infraFlavorListPrepared;
instTypeFields.poc[3].items.values = userFlavorListPrepared;
instTypeFields.sb[0].items.values = infraFlavorListPrepared;
instTypeFields.sb[3].items.values = userFlavorListPrepared;
instTypeFields.prod[0].items.values = infraFlavorListPrepared;
instTypeFields.prod[3].items.values = userFlavorListPrepared;
instTypeFields.high_prod[0].items.values = infraFlavorListPrepared;
instTypeFields.high_prod[3].items.values = userFlavorListPrepared;
