...
instTypeFields.poc.items[0].values = infraFlavorListPrepared;
instTypeFields.poc.items[3].values = userFlavorListPrepared;
instTypeFields.sb.items[0].values = infraFlavorListPrepared;
instTypeFields.sb.items[3].values = userFlavorListPrepared;
instTypeFields.prod.items[0].values = infraFlavorListPrepared;
instTypeFields.prod.items[3].values = userFlavorListPrepared;
instTypeFields.high_prod.items[0].values = infraFlavorListPrepared;
instTypeFields.high_prod.items[3].values = userFlavorListPrepared;
